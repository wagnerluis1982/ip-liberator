...
IP Liberator could always use more documentation, whether as part of the
official IP Liberator docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for 3.6 onwards, and for PyPy. Check
   https://travis-ci.org/wagnerluis1982/ip-liberator/pull_requests
